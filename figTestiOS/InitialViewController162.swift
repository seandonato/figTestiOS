...
class InitialViewController162 : UIViewController{
	...
	var loginimage11422img = UIImage(named:"login-image 1")
	var loginimage11422 = UIImageView()
	...
	func setup(){
		...
		self.view.addSubview(loginimage11422)
	...
	loginimage11422.image = loginimage11422img
	}
	...
	func stylize(){
		...
		loginimage11422.translatesAutoresizingMaskIntoConstraints = false
		NSLayoutConstraint.activate([loginimage11422.heightAnchor.constraint(equalToConstant:198),loginimage11422.widthAnchor.constraint(equalToConstant:216),loginimage11422.topAnchor.constraint(equalTo: self.view.topAnchor, constant:149),loginimage11422.leadingAnchor.constraint(equalTo: self.view.leadingAnchor, constant:73)])
