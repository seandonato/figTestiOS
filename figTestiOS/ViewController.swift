...
class ViewController: UIViewController{
	...
	func stylize(){
		...
		button269.setTitle("title",for: .normal)
		...
		NSLayoutConstraint.activate([text463.topAnchor.constraint(equalTo: self.view.topAnchor, constant:138),text463.leadingAnchor.constraint(equalTo: self.view.leadingAnchor, constant:166)])
		}
