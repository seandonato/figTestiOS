...
class ViewController: UIViewController{
	...
	func stylize(){
		...
		NSLayoutConstraint.activate([text463.topAnchor.constraint(equalTo: self.view.topAnchor, constant:53),text463.leadingAnchor.constraint(equalTo: self.view.leadingAnchor, constant:46)])
		}
