...
class ViewController: UIViewController{
	...
	func stylize(){
		...
		NSLayoutConstraint.activate([button268.heightAnchor.constraint(equalToConstant:87),button268.widthAnchor.constraint(equalToConstant:284),button268.topAnchor.constraint(equalTo: self.view.topAnchor, constant:481),button268.leadingAnchor.constraint(equalTo: self.view.leadingAnchor, constant:39)])
